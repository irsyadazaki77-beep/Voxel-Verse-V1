...
export const BIOME_VISUAL_PROFILES: Record<string, VisualProfile> = {
  plains: {
    ...
    skyColorNight: [0.04, 0.05, 0.14],
    fogColorDay: [0.75, 0.88, 0.98],
    fogColorSunset: [0.92, 0.65, 0.55],
    fogColorNight: [0.06, 0.07, 0.16],
    fogDensity: 0.008,
    sunColor: 0xfff6dd,
    sunIntensity: 1.25,
  ...
  forest: {
    ...
    skyColorNight: [0.03, 0.05, 0.12],
    fogColorDay: [0.65, 0.85, 0.82],
    fogColorSunset: [0.88, 0.60, 0.50],
    fogColorNight: [0.05, 0.07, 0.13],
    fogDensity: 0.010,
    sunColor: 0xffeedd,
    sunIntensity: 1.20,
  ...
  snow_mountain: {
    ...
    skyColorNight: [0.05, 0.06, 0.18],
    fogColorDay: [0.82, 0.90, 0.98],
    fogColorSunset: [0.85, 0.70, 0.78],
    fogColorNight: [0.07, 0.08, 0.20],
    fogDensity: 0.014,
    sunColor: 0xf4f8ff,
    sunIntensity: 1.35,
  ...
  desert: {
    ...
    skyColorNight: [0.05, 0.04, 0.12],
    fogColorDay: [0.92, 0.85, 0.72],
    fogColorSunset: [0.95, 0.60, 0.40],
    fogColorNight: [0.08, 0.06, 0.14],
    fogDensity: 0.009,
    sunColor: 0xfffae0,
    sunIntensity: 1.45,
  ...
  crystal: {
    ...
    skyColorNight: [0.06, 0.08, 0.22],
    fogColorDay: [0.45, 0.80, 0.92],
    fogColorSunset: [0.65, 0.45, 0.85],
    fogColorNight: [0.08, 0.12, 0.28],
    fogDensity: 0.012,
    sunColor: 0xd5f0ff,
    sunIntensity: 1.15,
  ...
  volcanic: {
    ...
    skyColorNight: [0.10, 0.03, 0.04],
    fogColorDay: [0.55, 0.30, 0.25],
    fogColorSunset: [0.70, 0.25, 0.18],
    fogColorNight: [0.15, 0.05, 0.06],
    fogDensity: 0.016,
    sunColor: 0xff8855,
    sunIntensity: 1.10,
  ...
  corrupted: {
    ...
    skyColorNight: [0.05, 0.02, 0.09],
    fogColorDay: [0.38, 0.25, 0.48],
    fogColorSunset: [0.50, 0.22, 0.55],
    fogColorNight: [0.08, 0.04, 0.14],
    fogDensity: 0.015,
    sunColor: 0xcc88ff,
    sunIntensity: 1.05,
