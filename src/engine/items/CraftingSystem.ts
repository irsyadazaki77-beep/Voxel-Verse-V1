...
export const CRAFTING_RECIPES: CraftingRecipe[] = [
  ...
  // ==========================================
  // 4. MASTERWORK ARTIFACT-UNLOCKED RECIPES
  // ==========================================
  {
    id: 'aether_lantern',
    ...
    output: { itemId: 'aether_lantern', count: 1 },
    xpReward: 35,
  },
  {
    id: 'leyline_compass',
    ...
    unlockedByDefault: false,
    inputs: [
      { itemId: 'ancient_glyph', count: 2 },
      { itemId: 'gold_ingot', count: 4 },
      { itemId: 'aether_crystal', count: 1 },
    ],
    output: { itemId: 'leyline_compass', count: 1 },
    xpReward: 40,
  },
  {
    id: 'kinetic_boots',
    ...
    unlockedByDefault: false,
    inputs: [
      { itemId: 'iron_boots', count: 1 },
      { itemId: 'ancient_alloy', count: 2 },
      { itemId: 'swiftness_potion', count: 2 },
    ],
    output: { itemId: 'kinetic_boots', count: 1 },
    xpReward: 50,
  },
  {
    ...
    output: { itemId: 'recharging_talisman', count: 1 },
    xpReward: 45,
  },
  {
    id: 'magma_furnace',
    ...
    inputs: [
      ...
      { itemId: 'magma_rock', count: 8 },
      { itemId: 'obsidian', count: 4 },
    ],
    output: { itemId: 'magma_furnace', count: 1 },
    xpReward: 60,
  },
  {
    id: 'pyroclast_blade',
    ...
    inputs: [
      ...
      { itemId: 'obsidian_core', count: 1 },
      { itemId: 'magma_rock', count: 4 },
    ],
    output: { itemId: 'pyroclast_blade', count: 1 },
    xpReward: 65,
  },
  {
    id: 'diver_mask',
    ...
    unlockedByDefault: false,
    inputs: [
      { itemId: 'iron_helmet', count: 1 },
      { itemId: 'glass', count: 2 },
      { itemId: 'coral_shard', count: 4 },
    ],
    output: { itemId: 'diver_mask', count: 1 },
    xpReward: 55,
  },
  {
    id: 'aquatic_spear',
    ...
    output: { itemId: 'aquatic_spear', count: 1 },
    xpReward: 60,
  },
  {
    id: 'void_greatsword',
    ...
    unlockedByDefault: false,
    inputs: [
      { itemId: 'mythril_saber', count: 1 },
      { itemId: 'void_eye', count: 1 },
      { itemId: 'obsidian_core', count: 2 },
    ],
    output: { itemId: 'void_greatsword', count: 1 },
    xpReward: 100,
  },
  {
    ...
    unlockedByDefault: false,
    inputs: [
      { itemId: 'mythril_chestplate', count: 1 },
      { itemId: 'ancient_alloy', count: 4 },
      { itemId: 'aether_crystal', count: 4 },
    ],
    output: { itemId: 'astral_plate_armor', count: 1 },
    xpReward: 120,
  },
  {
    ...
    unlockedByDefault: false,
    inputs: [
      { itemId: 'obsidian', count: 8 },
      { itemId: 'ancient_alloy', count: 2 },
      { itemId: 'void_eye', count: 1 },
    ],
    output: { itemId: 'dimensional_warp_anchor', count: 1 },
    xpReward: 150,
  },
  {
    id: 'astral_pickaxe',
    ...
    unlockedByDefault: false,
    inputs: [
      { itemId: 'mythril_pickaxe', count: 1 },
      { itemId: 'ancient_alloy', count: 2 },
      { itemId: 'aether_crystal', count: 2 },
    ],
    output: { itemId: 'astral_pickaxe', count: 1 },
    xpReward: 80,
  },
  {
    id: 'astral_battleaxe',
    ...
    unlockedByDefault: false,
    inputs: [
      { itemId: 'mythril_axe', count: 1 },
      { itemId: 'ancient_alloy', count: 2 },
      { itemId: 'aether_crystal', count: 2 },
    ],
    output: { itemId: 'astral_battleaxe', count: 1 },
    xpReward: 80,
  },
  {
    ...
    inputs: [
      ...
      { itemId: 'ancient_glyph', count: 2 },
      { itemId: 'glass', count: 4 },
      { itemId: 'gold_ingot', count: 4 },
    ],
    output: { itemId: 'alchemical_infuser', count: 1 },
    xpReward: 70,
  },
  // ==========================================
  // AETHER ENGINEERING & AUTOMATION 1.0 RECIPES
  // ==========================================
  {
    id: 'engineers_wrench',
    ...
    output: { itemId: 'engineers_wrench', count: 1 },
    xpReward: 10,
  },
  {
    id: 'ley_conduit',
    ...
    output: { itemId: 'ley_conduit', count: 8 },
    xpReward: 5,
  },
  {
    id: 'aether_core',
    ...
    output: { itemId: 'aether_core', count: 1 },
    xpReward: 20,
  },
  {
    id: 'crystal_sensor',
    ...
    output: { itemId: 'crystal_sensor', count: 1 },
    xpReward: 10,
  },
  {
    id: 'logic_rune',
    ...
    unlockedByDefault: true,
    inputs: [
      { itemId: 'stone_bricks', count: 2 },
      { itemId: 'copper_ingot', count: 2 },
    ],
    output: { itemId: 'logic_rune', count: 1 },
    xpReward: 10,
  },
  {
    id: 'delay_rune',
    ...
    output: { itemId: 'delay_rune', count: 1 },
    xpReward: 10,
  },
  {
    id: 'aether_actuator',
    ...
    inputs: [
      { itemId: 'iron_ingot', count: 4 },
      { itemId: 'wood_planks', count: 3 },
      { itemId: 'ley_conduit', count: 2 },
    ],
    output: { itemId: 'aether_actuator', count: 1 },
    xpReward: 15,
  },
  {
    id: 'item_funnel',
    ...
    output: { itemId: 'item_funnel', count: 1 },
    xpReward: 15,
  },
  {
    id: 'ley_harvester',
    ...
    inputs: [
      ...
      { itemId: 'iron_hoe', count: 1 },
      { itemId: 'aether_crystal', count: 2 },
    ],
    output: { itemId: 'ley_harvester', count: 1 },
    xpReward: 25,
  },
  {
    ...
    inputs: [
      ...
      { itemId: 'mythril_ingot', count: 2 },
      { itemId: 'aether_core', count: 1 },
    ],
    output: { itemId: 'resonance_fabricator', count: 1 },
    xpReward: 40,
  },
  {
    ...
    inputs: [
      { itemId: 'iron_ingot', count: 8 },
      { itemId: 'aether_crystal', count: 4 },
      { itemId: 'hunting_bow', count: 1 },
    ],
    output: { itemId: 'aether_sentinel_turret', count: 1 },
    xpReward: 45,
  },
  {
    id: 'aether_rail',
    name: 'Aether Rail Track (16x)',
    category: 'functional',
    station: 'crafting_bench',
    unlockedByDefault: true,
    inputs: [
    ...
    output: { itemId: 'aether_rail', count: 16 },
    xpReward: 10,
  },
  {
